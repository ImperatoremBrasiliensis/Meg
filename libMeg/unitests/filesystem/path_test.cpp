...
class FilesystemPathEnvironment: public testing::Environment {
	~FilesystemPathEnvironment() override {
	}

	void TearDown() override {
		if (dbg::get_exception_count()) {
			std::cout << "=======================================" << std::endl;
			std::cout << "\033[1mExceptions:\033[0m" << std::endl;
			std::cout << "--------------------------------------" << std::endl;
			for (const dbg::exception &e: dbg::get_exceptions()) {
				std::cout << "+ " << e.func_name << ',' << e.line << ": " << std::endl;
			...
			std::cout << "=======================================" << std::endl;
			std::cout << "\033[1mNo Exceptions found\033[0m" << std::endl;
			std::cout << "=======================================" << std::endl;
		}
	}
};
...
int main(int argc, char *argv[]) {
	...
	testing::AddGlobalTestEnvironment(new FilesystemPathEnvironment);
