...
is not related to network or internet protocols, but it's a
simple programming language with a Python-like syntax.

&emsp;&emsp;`libprotocols` is still in development and doesn't work in
